    ...
    .hero.bg-base-200.rounded-lg.p-10.m-4
        .hero-content.text-center.p-5
            .max-w-5xl.flex.flex-col.gap-5.items-center
                ...
                h1.font-extrabold.text-transparent.text-4xl.bg-clip-text.bg-gradient-to-r.from-purple-400.to-pink-600.font-bold
                    |  from India
                .py-6
                  p
                    | We take care of rest!
                  .font-bold.text-gray-600.py-4
                    | Payroll, Taxes & Benefits

    .text-center.p-5
      |According to the 2021 The State of the Octoverse survey conducted by Github, there are more than 7.2 million software developers from India
      a.pl-1(href="https://octoverse.github.com/#improving-how-we-work") ⓘ
    .text-center.mt-10
